...
<section id="three">
	<div class="inner">
		...
		<p>In addition to the listed professional experience above, Zishen also has several project experience working <br/>
with various data technique and software. Please click below or refer to the GitHub repository for more details</p>
		<ul class="actions">
